            ...
            <form action="#" id="signUpFrm" method="post">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <label id="emailerror" class="emailerror hide" for="email">Email address is already taken, please
                    ...
                    <div class="col-sm-6">
                        ...
                        <label id="mobileerror" class="mobileerror hide" for="phone">Mobile number is already taken, please
                            enter different</label>
                    </div>
                    <div class="col-sm-6">
                        <div class="input-field">
                    ...
                    <div class="col-sm-6">
                        <div class="input-field">
                            <input type="text" placeholder="Enter your teacher ID" required autocomplete="new-tId"
                                   name="teacherId" maxlength="15" id="tid">
                            <i class="uil uil-mobile-android"></i>
                        </div>
                    </div>
                    <div class="col-sm-6">
...
<script>
    ...
    $(document).on("click", ".signUpBtn", function () {
        ...
        if ($("#signUpFrm").valid()) {
            ...
            console.log(student);
            if (!student) {
                var email=chkemail($('#semail').val());

               var mob= chkmobile($('#smobile').val());
               console.log(email);
               console.log(mob);
               if(email==false||mob==false)
               {
                   return;
               }
            }
            $.ajax({
                type: "POST",
                url: base_url + "controller/StudentController.php?name=signup",
